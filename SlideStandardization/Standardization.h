...
class Standardization
{
	...
	private:
		...
		cv::Mat									CreateNormalizedImage_(const HSD::HSD_Model& hsd_lut, const TrainingSampleInformation& sample_info, const boost::filesystem::path& output_file, const boost::filesystem::path& template_output);
