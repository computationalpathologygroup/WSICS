#ifndef __WSICS_HOUGHTRANSFORM_WINDOWEDTRIPLETDETECTOR__
#define __WSICS_HOUGHTRANSFORM_WINDOWEDTRIPLETDETECTOR__
...
#endif // __WSICS_HOUGHTRANSFORM_WINDOWEDTRIPLETDETECTOR__
